...
public class SysUser {
    ...
    private String handSalt;

    private String headUrl;

    private Short realFlag;
    ...
    public String getHandSalt() {
        return handSalt;
    }

    public void setHandSalt(String handSalt) {
        this.handSalt = handSalt;
    }
    ...
    public Short getRealFlag() {
        return realFlag;
    }

    public void setRealFlag(Short realFlag) {
